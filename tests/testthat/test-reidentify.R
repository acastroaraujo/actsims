...
# test_that("reidentify replicates interact.jar US 2010", {
#
...
#                                  equation_gender = "all")
#
#   act <- interact(dictionary = list("usfullsurveyor2015", "all"), equations = list("us2010", "all"))
#
#   d <- act$deflection(list(A = "astronaut", B = "accommodate", O = "atheist"))
#   d
#
#   act$reidentify(d, who = "actor")
#   act$reidentify(d, who = "object")
#
#   act$optimal_behavior(d, "actor")
#
#   act$max_confirm(list(A = "astronaut", B = "accommodate", O = "atheist"), solve_for = "actor")
#
#
#
