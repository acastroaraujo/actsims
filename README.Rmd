...
_Note. The `create_modifier` function creates the `modify` function, which has built-in dictionaries and equations. This setup is still experimental._

## Situations

This function is what powers the Analyze Events pane in [`interactShiny`](https://acastroaraujo.shinyapps.io/interactShiny/)
